...
class Hcl extends Equatable {
  ...
  factory Hcl.fromMap(Map<String, dynamic> map) {
    return Hcl(
      id: map['id'] ?? '',
      email: map['email'] ?? '',
  ...
  factory Hcl.fromJson(String source) => Hcl.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Hcl(id: $id, email: $email, fullName: $fullName, phoneNumber: $phoneNumber, desc: $desc, coordinate: $coordinate, startingTime: $startingTime, endingTime: $endingTime, department: $department, branch: $branch, checkLists: $checkLists)';
  }
